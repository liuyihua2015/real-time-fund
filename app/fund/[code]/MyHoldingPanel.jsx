...
wimport { useEffect, useMemo, useRef, useState } from "react";
...
function TradeModalLite({ type, fund, unitPrice, onClose, onConfirm }) {
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          {ocrFields &&
          (ocrFields.amount || ocrFields.share || ocrFields.date) ? (
            <div
              className="glass"
              style={{
                marginTop: 10,
